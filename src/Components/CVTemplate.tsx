    ...
    return (
        ...
        >
            ...
            <header className="flex justify-between items-center bg-slate-900 text-white p-10 rounded-3xl mb-12 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-purple-600/20 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2" />

                <div className="space-y-2 relative z-10">
                    <h1 className="text-5xl font-black tracking-tighter uppercase leading-none">
                        Rabie Zakaria <br />
                        <span className="text-purple-400">Djebbar</span>
                    </h1>
                ...
                <div className="text-right space-y-2 relative z-10 font-medium text-[11px] tracking-wide text-slate-300 border-l border-slate-700 pl-8">
                    <div className="flex items-center justify-end gap-3">
                        <span>djabbarzakaria09@gmail.com</span> <FiMail className="text-purple-400" />
                    </div>
                    <div className="flex items-center justify-end gap-3">
                        <span>Algiers, Algeria</span> <FiMapPin className="text-purple-400" />
                    </div>
                    <div className="flex items-center justify-end gap-3">
                        <span>github.com/djabbarzakaria09-lgtm</span> <FiGithub className="text-purple-400" />
                    </div>
                </div>
            </header>
                ...
                <div className="col-span-4 space-y-12">
                            ...
                            {[
                                ...
                                <div key={skill.name}>
                                    ...
                                    <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                        <div className="h-full bg-gradient-to-right from-purple-600 to-blue-500" style={{ width: skill.level, backgroundColor: '#7c3aed' }}></div>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-50 p-4 rounded-2xl border-l-4 border-purple-500">
                                <h4 className="text-[10px] font-black uppercase text-slate-900">Digital Marketing</h4>
                                <p className="text-[9px] font-bold text-purple-600 uppercase mt-1">Ecole d'excellence - 2024</p>
                            </div>
                ...
                <div className="col-span-8 space-y-12">
                    <section>
                        <div className="flex items-center gap-4 mb-8">
                            <FiBriefcase className="text-purple-600" size={22} />
                        ...
                        <div className="space-y-12">
                            <div className="relative pl-8">
                                ...
                                <div className="absolute -left-[5px] top-2 w-3 h-3 bg-purple-600 rounded-full border-4 border-white shadow-sm"></div>

                                <div className="flex justify-between items-center mb-2">
                                    <h3 className="text-base font-black uppercase text-slate-900">ANEP Messagerie Express</h3>
                                    <span className="px-3 py-1 bg-purple-50 text-purple-700 text-[9px] font-black rounded-full">2024 — PRESENT</span>
                                </div>
                                <p className="text-[11px] font-bold text-purple-600 uppercase tracking-widest mb-3">Apprentice Full Stack Developer</p>
                    ...
                    <section>
                        <div className="flex items-center gap-4 mb-8">
                            <FiCheckCircle className="text-purple-600" size={22} />
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            {[
                                ...
                                { title: "Academic System", stack: "PHP / MySQL", desc: "Enterprise academic data management." },
                                { title: "Supermarket Store", stack: "React / Tailwind", desc: "High-performance e-commerce interface." },
                                ...
                                <div key={item.title} className="p-5 border border-slate-100 rounded-2xl hover:bg-slate-50 transition-colors">
                                    ...
                                    <p className="text-[8px] font-black uppercase text-purple-600 tracking-widest mb-2">{item.stack}</p>
            ...
            <footer className="mt-20 pt-10 border-t border-slate-100 flex justify-between items-center text-slate-400">
                <p className="text-[9px] font-black uppercase tracking-[0.4em]">© 2026 Djebbar Rabie Zakaria • Portfolio Ecosystem</p>
